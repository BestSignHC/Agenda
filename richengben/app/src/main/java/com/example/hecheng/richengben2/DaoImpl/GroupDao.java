...
public class GroupDao {
    ...
    public List<Group> queryGroupAll() {
        ...
        Cursor cursor = null;
        try {
            cursor = db.query("_Group", null, null, null, null, null, "g_create_time asc");
    ...
    public Group queryGroupByName(String groupName) {
        ...
        try {
            ...
            cursor = db.query("_Group", null, "g_name=?", new String[]{groupName}, null, null, null);
            while (cursor.moveToNext()) {
                int groupId = cursor.getInt(cursor.getColumnIndex("g_id"));
                int order = cursor.getInt(cursor.getColumnIndex("g_order"));
                String color = cursor.getString(cursor.getColumnIndex("g_color"));
    ...
    public Group queryGroupById(int groupId) {
        ...
        Cursor cursor = null;
        try {
            cursor = db.query("_Group", null, "g_id=?", new String[]{groupId + ""}, null, null, null);
            while (cursor.moveToNext()) {
                int order = cursor.getInt(cursor.getColumnIndex("g_order"));
                String color = cursor.getString(cursor.getColumnIndex("g_color"));
                int encrypt = cursor.getInt(cursor.getColumnIndex("g_encrypt"));
    ...
    public void updateGroup(Group group) {
        ...
        try {
            ...
            db.update("_Group", values, "g_id=?", new String[]{group.getId() + ""});
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            if (db != null) {
    ...
    public int deleteGroup(int groupId) {
        ...
        int ret = 0;
        try {
            ret = db.delete("_Group", "g_id=?", new String[]{groupId + ""});
