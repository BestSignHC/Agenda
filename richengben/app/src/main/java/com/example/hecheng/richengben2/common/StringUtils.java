...
public class StringUtils {
    ...
    public static String getImageName(String imaPath) {
        ///storage/emulated/0/XRichText/1494404970332-
        if(imaPath  != null  && imaPath.length() > 0) {
            int index = imaPath.lastIndexOf("/") + 1;
            String fileName = imaPath.substring(index);
            return fileName;
        }
        return "";
    }
