...
public class MyNoteListAdapter extends RecyclerView.Adapter<MyNoteListAdapter.ViewHolder>
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        while(noteContent.contains("<img")){
            int beginIndex = noteContent.indexOf("<img");
            int endIndex = noteContent.indexOf("/>");
            String removeCOntent =  noteContent.substring(beginIndex, endIndex + 2);
            noteContent = noteContent.replace(removeCOntent, "");
        }
        holder.tv_list_summary.setText(noteContent);
